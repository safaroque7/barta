...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <a href="{{ url('/') }}" class="text-center text-6xl font-bold text-gray-900">
                <h1>Barta</h1>
            </a>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('registrationRoute') }}" method="POST">
                @csrf
                <!-- Name -->
                <div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Already a member?
                <a href="{{ route('registrationRoute') }}"
